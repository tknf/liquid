...
import type { TagClass, TagImplOptions, FilterImplOptions, Template } from "./template";
import { createTagClass, Value } from "./template";
import { LookupType } from "./fs/loader";
import { Render } from "./render";
import { Parser } from "./parser";
import { tags } from "./tags";
import { filters } from "./filters";
import type { LiquidOptions, NormalizedFullOptions, RenderOptions, RenderFileOptions } from "./liquid-options";
import { normalizeDirectoryList, normalize, defaultOptions } from "./liquid-options";
import { forOwn, isFunction } from "./util/underscore";
...
export class Liquid {
  ...
  public constructor(opts: Partial<LiquidOptions> = {}) {
